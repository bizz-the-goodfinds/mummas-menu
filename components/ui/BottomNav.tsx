...
export function BottomNav() {
  ...
  return (
    <nav className="glass safe-area-bottom fixed right-0 bottom-0 left-0 z-[90] border-t border-white/60 md:hidden">
      <div className="flex items-center">
        ...
        <button
          onClick={openCart}
          className="relative flex flex-1 flex-col items-center gap-0.5 py-2.5 text-[10px] font-medium text-neutral-500"
