...
export default function NotFound() {
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center px-6 text-center">
      ...
      <h1 className="font-heading mb-3 text-[32px] font-bold md:text-[40px]">
        Oops! Page not found
      </h1>
      <p className="mb-8 max-w-[400px] text-[15px] leading-[1.7] text-neutral-500">
        Looks like this page went missing from the kitchen. Maybe it was too delicious and someone
        ate it? Try browsing our menu instead.
      </p>
